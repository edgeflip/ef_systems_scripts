...
# Fill this out
AS="eflip-production-ebs-rmq-as"
LC="eflip-production-64-ebs-rmq"
ELB="eflip-production-ebs-rmq-elb"
AMI="ami-a9bdbdc0"
SG="edgeflip-ec2-sg"
SIZE="m1.large"
CONFIG="/home/mrogers/projects/f4flip/src/aws_configs/rmq_ebs_launch_config"
