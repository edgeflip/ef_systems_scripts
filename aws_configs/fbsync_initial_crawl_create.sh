...
# Fill this out
AS="eflip-production-fbsync-initial-crawl-as"
LC="eflip-production-64-fbsync-initial-crawl"
ELB="eflip-production-fbsync-initial-crawl"
AMI="ami-d9d6a6b0"
SG="edgeflip-ec2-sg"
SIZE="m1.large"
CONFIG="/home/mrogers/projects/f4flip/src/aws_configs/fbsync_initial_crawl_config"
