...
# Fill this out
AS="eflip-production-fbsync-user-feeds-as"
LC="eflip-production-64-fbsync-user-feeds"
ELB="eflip-production-fbsync-user-feeds"
AMI="ami-d9d6a6b0"
SG="edgeflip-ec2-sg"
SIZE="m1.large"
CONFIG="/home/mrogers/projects/f4flip/src/aws_configs/fbsync_user_feeds_launch_config"
