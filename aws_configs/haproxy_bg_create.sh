...
# Fill this out
AS="eflip-production-fbsync-haproxy-as"
LC="eflip-production-64-fbsync-haproxy"
ELB="eflip-production-fbsync-haproxy"
AMI="ami-d9d6a6b0"
SG="edgeflip-ec2-sg"
SIZE="m1.medium"
CONFIG="/home/mrogers/projects/f4flip/src/aws_configs/haproxy_launch_config"
