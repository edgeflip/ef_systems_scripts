...
# Fill this out
AS="eflip-production-bg-celery-as"
LC="eflip-production-64-bg-celery"
ELB="eflip-production-bg-celery"
AMI="ami-d9d6a6b0"
SG="edgeflip-ec2-sg"
SIZE="m1.large"
CONFIG="/home/mrogers/projects/f4flip/src/bg_queues_prod_launch_config"
