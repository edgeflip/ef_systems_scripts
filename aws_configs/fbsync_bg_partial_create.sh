...
# Fill this out
AS="eflip-production-db-partial-fbsync-as"
LC="eflip-production-64-db-partial-fbsync"
ELB="eflip-production-db-fbsync"
AMI="ami-d9d6a6b0"
SG="edgeflip-ec2-sg"
SIZE="m1.large"
CONFIG="/home/mrogers/projects/f4flip/src/aws_configs/fbsync_bg_partial_launch_config"
